...
export default function Home() {
  return (
    <div className="w-full h-full md:grid md:grid-cols-2 lg:grid-cols-12">

      <div className="h-full md:col-span-1 lg:col-span-5">
        <ScrollArea className="h-screen">
          <div className="flex justify-center"> {/* width ta 100%, centraliza */}
            <div className="w-[90%] md:w-[80%]"> {/* width é limitado, mas já esta centralalizado */}
